...
@section('title', 'Tambah Sepeda Baru')

@section('content')
<div class="container-fluid px-4">
    <h1 class="mt-4">Tambah Sepeda Baru</h1>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.products.bikes.store') }}" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" 
                                       ...
                                       value="{{ old('specifications.engine') }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" 
                                       ...
                                       value="{{ old('specifications.displacement') }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" 
                                       ...
                                       value="{{ old('specifications.power') }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" 
                                       ...
                                       value="{{ old('specifications.torque') }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" 
                                       ...
                                       value="{{ old('specifications.transmission') }}">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" 
                                       ...
                                       value="{{ old('specifications.weight') }}">
                            </div>
                        </div>
                    </div>
                </div>
